      ...
      <div className="container relative z-10">
        <div className="mb-12 grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          ...
          <p className="max-w-2xl text-base leading-7 text-blue-100 sm:text-lg">
            Esta é uma demonstração fictícia de como a Prime transforma uma aula em contexto, direção e próxima ação. O professor permanece no centro; a tecnologia organiza o que precisa continuar.
          </p>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[1.08fr_0.92fr]">
          <div className="rounded-[2rem] border border-white/15 bg-white/[0.08] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.18)] backdrop-blur sm:p-7">
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-5">
              <div>
                <p className="text-xs font-bold uppercase tracking-[0.18em] text-blue-200">Exemplo ilustrativo</p>
                <h3 className="mt-2 font-display text-2xl font-bold">Seu próximo foco de aprendizagem</h3>
              </div>
              <span className="rounded-full border border-emerald-300/30 bg-emerald-300/10 px-3 py-1 text-xs font-semibold text-emerald-100">Professor validado</span>
            </div>

            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl bg-white p-4 text-[#0b2c5c] sm:col-span-2">
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-slate-500">Objetivo atual</p>
                <p className="mt-3 font-display text-xl font-bold">Comunicar uma ideia profissional com mais clareza.</p>
                <p className="mt-3 text-sm leading-6 text-slate-600">A próxima atividade parte de um contexto que faz sentido para você — não de um exercício genérico.</p>
              </div>
              <div className="rounded-2xl bg-[#eaf2fb] p-4 text-[#0b2c5c]">
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-slate-500">Próxima ação</p>
                <p className="mt-3 font-display text-lg font-bold">Praticar uma resposta de 60 segundos</p>
                <div className="mt-5 flex items-center gap-2 text-xs font-semibold text-[#24558b]"><CheckCircle2 className="h-4 w-4" /> Em foco agora</div>
              </div>
            </div>

            <div className="mt-4 rounded-2xl border border-white/10 bg-[#071f44] p-4 sm:p-5">
              <div className="flex items-center justify-between gap-3">
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-blue-200">Evidência da aula</p>
                <span className="text-xs text-blue-200">Exemplo sem dados reais</span>
              </div>
              <p className="mt-3 text-sm leading-6 text-blue-50">“Você comunica ideias relevantes quando o assunto faz parte da sua experiência. O próximo passo é organizar a resposta e ganhar mais segurança na estrutura.”</p>
            </div>
          </div>
