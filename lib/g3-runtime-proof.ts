import { CanonicalizationError, type CanonicalAuthorityDraft, type CanonicalizationCommand, type CanonicalizationResult } from '@/lib/canonicalization'
...
export async function runG3RuntimeProof(taskId: string) {
  ...
  const suggested = task.suggestedValue as CanonicalAuthorityDraft
