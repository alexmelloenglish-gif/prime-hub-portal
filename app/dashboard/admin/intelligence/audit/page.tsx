  ...
  return (
    <section className="space-y-4">
      <div className="glass-card p-5 md:p-6">
        <p className="text-xs uppercase tracking-[0.2em] text-prime-cream/45">Technical Audit</p>
        <h2 className="mt-1 text-xl font-semibold text-white">Historical system events</h2>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-prime-cream/60">This is a read-only technical history for troubleshooting and audit. These records do not represent the learner&apos;s current learning state and are intentionally kept separate from the day-to-day teacher workspace.</p>
        <div className="mt-4 flex flex-wrap gap-2"><IntelligenceStatusBadge label="Historical" state="PRESENT" /><IntelligenceStatusBadge label="Read-only" state="PRESENT" /></div>
      </div>
