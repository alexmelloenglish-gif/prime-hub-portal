...
export const metadata: Metadata = {
  ...
  description:
    'Aulas de inglês online ao vivo para objetivos reais, com professor como autoridade, aluno no centro, memória da aprendizagem e direção clara para sua evolução.',
