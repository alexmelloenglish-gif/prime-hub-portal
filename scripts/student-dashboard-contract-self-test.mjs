...
assert.equal(italo.canonicalProjection.currentState.targetLevel.value, null)
assert.equal(italo.canonicalProjection.currentState.targetLevel.status, 'not-available')
